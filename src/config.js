...
export const configFields = [
  ...
  { key: 'usdUyu', label: 'Cotización del dólar', unit: 'UYU/USD', type: 'number', min: 0.000001, step: 0.001, decimals: 3, description: 'Pesos por dólar. Valor de referencia de tu primera captura; actualizalo manualmente.' },
